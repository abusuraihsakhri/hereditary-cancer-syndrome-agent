"""
Automated Pytest for hereditary-cancer-syndrome-agent Enrichment Modules.
"""
import sys
...
from enrichment import (
    OverviewEngine,
    HereditaryCancerGeneticCounselingWorkflowWithPedigreeGenerationEngine,
    GoalEngine,
    ...
    AgentChangesEngine,
    ApiChangesEngine,
    HereditarycancersyndromeagentEnrichmentSuite,
    enrichment_suite,
)

def test_enrichment_suite_execution():
    suite = HereditarycancersyndromeagentEnrichmentSuite()
