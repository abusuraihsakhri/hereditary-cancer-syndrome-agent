...
**Hereditary Cancer Syndrome Agent** is an advanced analytical and computational platform implementing NCCN 3-Generation Pedigree Genetic Testing Criteria Agent.
...
docker run -p 8000:8000 hereditary-cancer-syndrome-agent
```
