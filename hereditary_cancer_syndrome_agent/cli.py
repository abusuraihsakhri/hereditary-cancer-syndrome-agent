"""
Command-Line Interface for HereditaryCancer Sentinel: Germline Variant & NCCN Genetic Testing Criteria Agent.
"""
import argparse
import csv
import json
...
def main(argv=None):
    ...
    if args.command == "audit":
        ...
        print(f"  Domain: Cancer Genetics | Standard: NCCN Genetic / Familial High-Risk Criteria")
        ...
        for idx, r in enumerate(rows):
            try:
                case = ClinicalCasePayload(
                    ...
                    patient_synthetic_id=r.get("patient_synthetic_id", f"SYNTH-{idx+1:04d}"),
